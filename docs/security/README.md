...
![An animated `/magpie-setup config` run for the security family: the check failing, the values derived from the repository, one question for the rest, and gitignored files written](../../assets/quickstart/wizard/security.svg)
