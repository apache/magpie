...
framework [install recipes](../quick-start/other-install-methods.md) verbatim — `git
...
- [`docs/setup/install-recipes.md`](../quick-start/other-install-methods.md) — the fetch/verify recipes reused per source.
