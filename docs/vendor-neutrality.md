...
**Overall vendor-neutrality score: 10/11 capability contracts (91%).** Generated by [`tools/vendor-neutrality-score`](../tools/vendor-neutrality-score/); re-run it to refresh this section.
