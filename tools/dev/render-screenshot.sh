...
#
# Nothing here shells out to Node, and nothing in this repository does any more:
# the recorder that needed svg-term-cli is retired. This runs on a bare clone
# and in CI.
#
# Usage:
...
# Generated by render-wizard.py from frontmatter, not from a transcript.
WIZARD_DIR="assets/quickstart/wizard"
