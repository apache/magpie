...
- **release-verify-rc** — 17 cases across 7 suites (step-0-preflight, step-2-verify-signatures, step-3-verify-checksums, step-5-notice-license, step-6-binary-exclusion, step-8-version-consistency, step-9-reproducibility)
