...
- **security-issue-fix** — 38 cases across 12 steps (2, 4a, 4b, 4c, 4d, 4e, 4f, 4g, 5, 7, 10)
...
- **setup-upstream-fix** — 10 cases across 3 suites (step-2-classify, step-3-dedup, step-5-adversarial-review)
