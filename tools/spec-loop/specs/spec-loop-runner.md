...
| Gemini CLI | `--prompt "<prompt>"` | launched from repo root | `--approval-mode default` | `--model` | `--output-format` | tool-sandboxing and Gemini policy; headless actions needing confirmation are refused |
