...
- [`issue-reproducer`](../reproducer/SKILL.md) — invoke when
...
- [`issue-reassess`](../reassess/SKILL.md) — sibling for
...
[`setup upgrade`](../../../magpie-setup/skills/setup/upgrade.md). The proposal
...
- [`issue-fix-workflow`](../fix-workflow/SKILL.md) — invoke
