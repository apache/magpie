...
- [`issue-triage`](../triage/SKILL.md) — the main triage skill for
...
- [`issue-reassess`](../reassess/SKILL.md) — the campaign skill for
  resolved / EOL pools.
- [`docs/issue-management/README.md`](../../../../docs/issue-management/README.md) —
  family overview.
- [`security-issue-sync`](../../../magpie-security/skills/issue-sync/SKILL.md) — the
