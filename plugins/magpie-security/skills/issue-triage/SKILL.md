...
6. **Cross-reference search** — for `PROBABLE-DUP` detection,
   ...
   [`security-issue-import` Step 2a](../issue-import/SKILL.md#step-2a--search-for-related-potentially-duplicate-existing-trackers)
...
[`security-issue-import`](../issue-import/SKILL.md#step-2a--search-for-related-potentially-duplicate-existing-trackers)),
